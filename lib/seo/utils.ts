...
import { seoConfig, pagesSEO, structuredData, generateBreadcrumbData, BASE_URL, SITE_NAME } from './config';
...
export function generateMetadata({
  ...
  const finalDescription = description || pageConfig?.description || config.description;
...
export function generateWebApplicationStructuredData(language: Language = 'en') {
  return {
...
export function generateSEOUrl(title: string, language: Language = 'en'): string {
  return title
    .toLowerCase()
