              ...
              {debugInfo && (
                <div className="space-y-3">
                    ...
                    {debugInfo.user && (
                      <div className="text-xs mt-2 space-y-1">
                        ...
                        <div className={`font-semibold ${
                          debugInfo.user.role === 'admin' ? 'text-green-400' : 'text-red-400'
                        }`}>
                  ...
                  <div className="bg-slate-800/30 p-3 rounded">
                    ...
                    <pre className="text-xs font-mono mt-1 p-2 bg-slate-800/80 rounded border border-slate-700/50 overflow-auto max-h-32">
