...
export default function HomePage() {
  ...
  return (
    <>
      {/* Enhanced SEO Head */}
      <Head>
        <title>Free Clouds - Secure Cloud Storage & File Sharing Platform</title>
        <meta name="description" content="Free secure cloud storage powered by Telegram. Upload, organize, and share your files with enterprise-grade security. 50MB file limit, unlimited folders, blazing-fast access." />
        <meta name="keywords" content="cloud storage, file sharing, free storage, telegram storage, secure file upload, online storage, file management, cloud backup" />
        <link rel="canonical" href={BASE_URL} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Free Clouds - Secure Cloud Storage & File Sharing Platform" />
        <meta property="og:description" content="Free secure cloud storage powered by Telegram. Upload, organize, and share your files with enterprise-grade security." />
        <meta property="og:url" content={BASE_URL} />
        <meta property="og:image" content={`${BASE_URL}/logo-with-text.png`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Free Clouds - Secure Cloud Storage & File Sharing Platform" />
        <meta name="twitter:description" content="Free secure cloud storage powered by Telegram. Upload, organize, and share your files with enterprise-grade security." />
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                ...
                <span className="block mt-2 text-lg">
                  🇻🇳 <em>Lưu trữ an toàn, truy cập mọi lúc mọi nơi với Free Clouds</em>
                </span>
              </p>
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                ...
                <span className="block mt-2 text-lg text-gray-500">
                  <em>Đơn giản, an toàn và đáng tin cậy với đầy đủ tính năng bạn cần</em>
                </span>
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-600">
              <div className="text-center">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Free Plan <span className="text-lg text-gray-500">/ Gói Miễn Phí</span>
                </h3>
