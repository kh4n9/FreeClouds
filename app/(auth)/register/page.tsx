    ...
    return (
      <AuthShell>
        <div className="modal-content p-10 text-center max-w-md w-full">
          ...
          <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-3">Registration successful!</h2>
          <p className="text-sub mb-4">Your account has been created.</p>
  ...
  return (
    <AuthShell>
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-2">Create account</h1>
        <p className="text-sub">Join Free Clouds today</p>
      </div>
      ...
      <div className="modal-content p-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input id="name" name="name" type="text" autoComplete="name" required
                ...
                className={`input-modern w-full pl-10 pr-4 py-3 rounded-xl ${error?.field === "name" ? "border-error/50 bg-error/5" : ""}`}
                placeholder="Enter your name" disabled={loading} />
            </div>
            {error?.field === "name" && <p className="mt-1.5 text-sm text-error">{error.message}</p>}
          </div>
          ...
          <div>
            ...
            {error?.field === "password" && <p className="mt-1.5 text-sm text-error">{error.message}</p>}
          </div>
